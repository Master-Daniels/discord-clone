...
const MemberIdPage = async ({ params, searchParams }: MemberIdPageProps) => {
    ...
    if (!currentUser) return redirect("/create-server");

    let conversation;
    const sameMember = currentUser.id === params.memberId;
    if (!sameMember) {
        conversation = await getOrCreateConversation(currentUser.id, params.memberId);
    }
